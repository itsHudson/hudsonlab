  ...
  "node_modules/rollup/dist/native.js"(exports, module) {
    ...
    var getReportHeader = () => {
      ...
      try {
        ...
        const script = "console.log(JSON.stringify(require('node:process').report.getReport().header));";
        ...
        const stdout = (_a = child.stdout) == null ? void 0 : _a.replace(/undefined\r?\n?$/, "").trim();
        if (!stdout) {
          return null;
        }
    ...
    var isMingw32 = () => {
      var _a;
      reportHeader ?? (reportHeader = getReportHeader());
      return ((_a = reportHeader == null ? void 0 : reportHeader.osName) == null ? void 0 : _a.startsWith("MINGW32_NT")) ?? false;
    };
    var isMusl = () => {
      reportHeader ?? (reportHeader = getReportHeader());
...
var URL_LOAD = "plugin-development/#load";
var URL_TRANSFORM = "plugin-development/#transform";
function error(base) {
...
var CIRCULAR_CHUNK = "CIRCULAR_CHUNK";
...
var FILE_NAME_OUTSIDE_OUTPUT_DIRECTORY = "FILE_NAME_OUTSIDE_OUTPUT_DIRECTORY";
...
function logCircularChunk(cyclePath, isManualChunkConflict) {
  return {
    code: CIRCULAR_CHUNK,
    ids: cyclePath,
    message: `Circular chunk: ${cyclePath.join(" -> ")}. ${isManualChunkConflict ? `Please adjust the manual chunk logic for these chunks.` : `Consider disabling the "output.onlyExplicitManualChunks" option, as enabling it causes the static dependencies of the manual chunk "${cyclePath.at(-2)}" to be bundled into the chunk "${cyclePath.at(-1)}".`}`
  };
}
...
rollup/dist/es/shared/parseAst.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-GFEZY7RI.js.map
